...
function finetune() {
    ...
    if [[ $EVAL_FLAG == false ]]; then
      python $SCRIPT_PATH \
          ...
          --test_filename /Dataset/test_cache.jsonl \
      ...
      python $SCRIPT_PATH \
          --do_test \
          --train_filename /Dataset/CommitMsgGeneration/train.jsonl \
          --dev_filename ${CURRENT_DIR}/Dataset/fine-tuning/CommitMsgGeneration/valid.jsonl \
          --test_filename /Dataset/commitgen/_cache.jsonl \
          --model_type codet5_CC \
          --warmup_steps 500 \
          --learning_rate 3e-4 \
          --tokenizer_name /CodeT5/CodeT5/models/codet5-base \
